@echo off
title AI Agent System - Voice Fixed

echo Starting AI Agent System with Voice Fix...
...
echo Cleaning up...
docker-compose -f docker-compose.voice.fixed.yml down >nul 2>&1
...
echo Building...
docker-compose -f docker-compose.voice.fixed.yml build --no-cache
